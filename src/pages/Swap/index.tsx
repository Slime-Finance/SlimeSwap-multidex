...
import { CardBody, ArrowDownIcon, Button, IconButton, Text,Heading } from 'uikit'
...
const SwapForm = () => {
  ...
  const [approval, approveCallback] = useApproveCallbackFromTrade(swapRouter, trade, allowedSlippage)
    ...
    <>
      ...
      <AppBody>
        <Wrapper id="swap-page">
          ...
          />
          <PageHeader
            title={`Exchange ${swapRouter === SwapRouters[SwapNames.SLIME] ? 'Slime' : 'Pancake'}`}
